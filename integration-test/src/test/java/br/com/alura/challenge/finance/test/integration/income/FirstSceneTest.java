package br.com.alura.challenge.finance.test.integration.income;
...
@DisplayName("Income First Scene Test")
public class FirstSceneTest extends AuthenticatedAccess implements ResponseLinkHateoas {
	...
	class MehtodPost {
		...
		@ParameterizedTest
		// @formatter:off
		@CsvSource({ "income::Salario    :2600  :01/08/2022", 
					 "income::Renda extra:400.30:15/08/2022",
					 "income::Outros     :420   :01/08/2022", 
					 "income::TO UPDATE  :0     :01/01/2022" })
		// @formatter:on
		void shouldCeateFinanceList(@ConvertWith(FinanceConverter.class) Income entity) throws JsonProcessingException {
