...
import br.com.alura.challenge.finance.test.integration.standard.StandardResourceCrudFirstTest;
import br.com.alura.challenge.finance.test.tool.response.ListHateoasFormat;
import br.com.alura.challenge.finance.test.tool.response.NoContent;
import br.com.alura.challenge.finance.test.tool.response.RecordNotFound;
import br.com.alura.challenge.finance.test.tool.response.SingleHateoasFormat;
import br.com.alura.challenge.finance.test.tool.standard.StandardDeleteTest;
import br.com.alura.challenge.finance.test.tool.standard.StandardPutTest;
...
public class ExpenditureIntegrationTest {
	...
	class MehtodPostimplements implements FinanceListPostTest<Expenditure> {
		...
		@ParameterizedTest
		@CsvSource({ "expenditure::Salario    :2600  :01/08/2022", "expenditure::Renda extra:400.30:15/08/2022",
				"expenditure::Outros     :420   :01/08/2022", "expenditure::TO UPDATE  :0     :01/01/2022" })
