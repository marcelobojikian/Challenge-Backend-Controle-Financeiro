package br.com.alura.challenge.finance.integration;
...
import br.com.alura.challenge.finance.integration.rest.BusinessExceptionTest;
import br.com.alura.challenge.finance.integration.rest.FinanceListPostTest;
import br.com.alura.challenge.finance.integration.standard.StandardResourceCrudFirstTest;
import br.com.alura.challenge.finance.model.Expenditure;
import br.com.alura.challenge.finance.parameter.FinanceConverter;
import br.com.alura.challenge.finance.rest.response.ListHateoasFormat;
import br.com.alura.challenge.finance.rest.response.NoContent;
import br.com.alura.challenge.finance.rest.response.RecordNotFound;
import br.com.alura.challenge.finance.rest.response.SingleHateoasFormat;
import br.com.alura.challenge.finance.rest.standard.StandardDeleteTest;
import br.com.alura.challenge.finance.rest.standard.StandardPutTest;
...
public class ExpenditureIntegrationTest {
	...
	static final String RESOURCE_NAME_COLLECTION_RELATION = ExpenditureReference.NAME_COLLECTION_RELATION;
	...
	class MehtodPostimplements implements FinanceListPostTest<Expenditure> {
		...
		@ParameterizedTest
		@CsvSource({
			"expenditure::Salario    :2600  :01/08/2022",
			"expenditure::Renda extra:400.30:15/08/2022",
			"expenditure::Outros     :420   :01/08/2022",
			"expenditure::TO UPDATE  :0     :01/01/2022"})
		public void each(@ConvertWith(FinanceConverter.class) Expenditure entity) throws JsonProcessingException {
